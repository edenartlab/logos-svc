...
router.add_api_route(
    path="/animation/monologue",
    endpoint=animated_monologue,
    methods=["POST"],
)
router.add_api_route(
    path="/animation/dialogue",
    endpoint=animated_dialogue,
    methods=["POST"],
)
...
router.add_api_route(
    path="/animation/comic",
    endpoint=illustrated_comic,
    methods=["POST"],
)

router.add_api_route(
    path="/kojii/makeitrad",
    endpoint=kojii_makeitrad,
    methods=["POST"],
)
router.add_api_route(
    path="/kojii/va2rosa",
    endpoint=little_martian_poster,
    methods=["POST"],
)
router.add_api_route(path="/kojii/chebel", endpoint=kojii_chebel, methods=["POST"])
router.add_api_route(
    path="/kojii/untitledxyz",
    endpoint=kojii_untitledxyz,
    methods=["POST"],
)
router.add_api_route(
    path="/kojii/violetforest",
    endpoint=kojii_violetforest,
    methods=["POST"],
)
...
router.add_api_route(
    path="/tasks/moderation",
    endpoint=tasks.moderation,
    methods=["POST"],
)
