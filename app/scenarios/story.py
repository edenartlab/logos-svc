...
def story(request: StoryRequest):
    ...
    CharacterNameEnum = Enum(
        "CharacterNameEnum", {name: name for name in character_names}
    )
    ...
    class DynamicStoryClip(StoryClip):
        ...
        character: Optional[CharacterNameEnum] = Field(
            description="Character name if voiceover mode is character, otherwise null (possible values: {})".format(
